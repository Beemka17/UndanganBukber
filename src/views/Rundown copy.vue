<template>
  <div class="min-h-screen w-full" :style="{ backgroundImage: `url(${bgImage})` }">
    <header class="pt-20 pb-20 flex justify-center flex-col items-center" v-animate>
      <h1 class="text-4xl font-family-serif text-amber-400 !font-bold text-center">
        Rundown <br />Acara
      </h1>
      <div class="w-3/4 px-2 pt-2">
        <p class="text-black text-lg font-family-sans text-center">
          Biar <span class="italic">{{ namaTamu }}</span> tau bakal ada acara apa aja
        </p>
      </div>
    </header>

    <div id="timeline" class="container mx-auto mt-40" v-animate>
      <ul class="timeline timeline-snap-icon timeline-vertical px-4">
        <li>
